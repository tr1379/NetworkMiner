...
namespace PacketParser.Utils {
    public class BoyerMoore {
         ...
         */
        public static int IndexOf(byte[] haystack, byte[] needle, int offset = 0) {
            if (needle.Length == 0) {
                return 0;
            }
        ...
        public static int IndexOf(byte[] haystack, byte[] needle, int[] byteTable, int[] offsetTable, bool ignoreCase, int offset = 0) {
            if (!ignoreCase)
                ...
                for (int i = offset + needle.Length - 1, j; i < haystack.Length; ) {
        ...
        public static int IndexOf(byte[] haystack, byte[] needle, int[] byteTable, int[] offsetTable, int offset = 0) {
            if (needle.Length == 0) {
                return 0;
            }
            for (int i = offset + needle.Length - 1, j; i < haystack.Length; ) {
